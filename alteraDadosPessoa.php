    ...
    <img src="assets/profile.png" alt="img" style="max-width: 400px;">
      ...
      <div class="column">
        ...
        <div class="field">
              ...
              <div class="control">
                <input class="input is-narrow" type="text" name="id" readonly value=
                "<?php 
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="text" placeholder="Nome" name="name" value=
                "<?php 
                        require('conectaBanco.php');
            ...
            <div class="field">
              ...
              <div class="control">
                  <input class="input" type="text" placeholder="Login"  name="login" value=
                  "<?php 
                        require('conectaBanco.php');
                        $login = $_SESSION['usuario'];
